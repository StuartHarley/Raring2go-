export const auditActions = {
  ...
  marketingEmailCampaignVersionCreate: "marketing.email.campaign_version.create",
  ...
  integrationReconnected: "integration.reconnected",
  integrationRevoked: "integration.revoked",
  integrationHealthFailed: "integration.health_failed",
